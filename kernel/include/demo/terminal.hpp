...
namespace demo {
    ...
    public:
        ...
        // TODO: Ideally we wanna read from binPath, check for executable with correct name and spawn a sub process
        // So for that we need to build some more abstractions around process (kthread):
