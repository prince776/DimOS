...
class RamDisk : FileSystem {
  public:
    ...
    static constexpr int DirEntryCntPerBlock =
        (BlockSize - sizeof(DirHeader)) / sizeof(vfs::DirEntry);
    struct Dir {
        DirHeader header{};
    ...
    int read(const Resource& resource, uint32_t offset, uint32_t size,
  ...
  private:
    ...
    class DataBitsetAllocator {
      ...
      public:
        ...
        DataBitsetAllocator(Blk data) : data(data) {}
